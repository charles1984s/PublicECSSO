                ...
                <div class="row loginborder">
                    <div class="col-md-12">
                        ...
                        <div class="row login" style="padding:3px 3px;">
                            ...
                            <div class="col-md-9 col-xs-9">
                                <asp:TextBox ID="UserPwd" runat="server" TextMode="Password" Width="80%" AutoCompleteType="Disabled"
                        ...
                        <div class="row login" style="padding:3px 3px;">
                            ...
                            <div class="col-md-9 col-xs-9">
                                <asp:TextBox ID="TextBox1" runat="server" Width="40%" AutoCompleteType="Disabled"
