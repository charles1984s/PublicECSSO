        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.Form["CheckM"] != null)
                {
                    ...
                    {
                        CheckM = HttpUtility.HtmlEncode(Request.Form["CheckM"].ToString());
                        this.Checkm.Value = HttpUtility.HtmlEncode(Request.Form["CheckM"].ToString());
                    }
                }
                else
                {
                    if (Request.QueryString["CheckM"] != null)
                    {
                        ...
                        {
                            CheckM = HttpUtility.HtmlEncode(Request.QueryString["CheckM"].ToString());
                            this.Checkm.Value = HttpUtility.HtmlEncode(Request.QueryString["CheckM"].ToString());
                        }
                    }
                }
                #endregion
                            ...
                            if (reader.HasRows)
                            {
                                while (reader.Read())
                                {
                                    ...
                                    if (reader[4].ToString() != "")
                                    {
                                        ...
                                        {
                                            Image3.ImageUrl = HttpUtility.HtmlEncode(reader[4].ToString());
                                        }
                                        else
                                        {
                                            Image3.ImageUrl = this.weburl.Value + HttpUtility.HtmlEncode(reader[4].ToString());
                                        }
