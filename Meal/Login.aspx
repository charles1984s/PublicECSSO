                ...
                <div id="add_login_btn" class="row">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox ID="Pwd" runat="server" Width="300px" TextMode="Password" AutoCompleteType="Disabled"
                    ...
                    <div class="row" style="border-bottom:1px dotted #d4d4d4; padding-bottom:20px;">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox ID="ChkPwd" runat="server" Width="300px" TextMode="Password" AutoCompleteType="Disabled"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <asp:TextBox ID="TextBox2" runat="server" Width="200px" AutoCompleteType="Disabled"
