<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Booking.Manage" %>
                ...
                <div class="row loginborder">
                    <div class="col-md-12">
                        ...
                        <div class="row login" style="padding:3px 3px;">
                            ...
                            <div class="col-md-9 col-xs-9">
                                <asp:TextBox ID="UserPwd" runat="server" TextMode="Password" Width="80%" 
                                    meta:resourcekey="UserPwdResource1" AutoCompleteType="Disabled"></asp:TextBox>
            ...
            <div class="row" id="foot">
                <div class="col-md-12 fontcenter" style="padding:17px;">   
                    <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank" 
                        NavigateUrl="http://ec.hisales.hinet.net/index.asp?au_id=10" 
                        meta:resourcekey="HyperLink1Resource1">常見問題 <span class="glyphicon glyphicon-exclamation-sign icon"></span></asp:HyperLink>
                    <asp:HyperLink ID="HyperLink2" runat="server" Target="_blank" 
                        NavigateUrl="http://ec.hisales.hinet.net/index.asp?au_id=11" 
                    ...
                    <asp:HyperLink ID="HyperLink3" runat="server" Target="_blank" 
                        NavigateUrl="http://ec.hisales.hinet.net/index.asp?au_id=21" 
