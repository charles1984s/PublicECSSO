        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <asp:TextBox ID="CellPhone" runat="server" Width="300px" 
                    meta:resourcekey="CellPhoneResource1" />
        ...
        <div class="row" style="border-bottom:1px dotted #d4d4d4; padding-bottom:20px;">
            ...
            <div class="col-md-10">
                <asp:TextBox ID="ChkPwd" runat="server" Width="300px" TextMode="Password" 
                    meta:resourcekey="ChkPwdResource1" />
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <asp:LinkButton ID="LinkButton1" runat="server" 
                    ...
                    style="margin-right:20px;" ><span class="glyphicon glyphicon-user" style="font-size:large; margin-right:7px;"></span>
                    Send
                </asp:LinkButton>
