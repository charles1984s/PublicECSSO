    ...
    public partial class index : System.Web.UI.Page
    {
        ...
        {   
            if (!IsPostBack)
            {
                ...
                {
                    if ((Request["SiteID"].ToString() != null) && (Request["ReturnUrl"].ToString() != null) && (Request["Url"].ToString() != null) && (Request["language"].ToString() != null))
                    {
                    ...
                    if ((Session["siteid"].ToString() != null) && (Session["returnurl"].ToString() != null) && (Session["weburl"].ToString() != null) && (Session["language"].ToString() != null))
                    {
                        if (Request["Code"] != null)
                        {
                            ...
                            if (Conn.LoginOrReg(Session["siteid"].ToString(), JsonUserEmail.ToString()))
                            {
                                ...
                                string RedirectTemp = Session["weburl"].ToString() + "/" + getstr.GetLanString(Session["language"].ToString()) + "/log.asp?id=" + JsonUserEmail.ToString() + "&tokenid=" + TokenID + "&ReturnUrl=" + Session["returnurl"].ToString().Replace("&", "////").Split('?')[1];
                                removeSession();
                            ...
                            {
                                string RedirectTemp = Session["returnurl"].ToString();
                                removeSession();
                                Response.Redirect(RedirectTemp);
                                return;
                            }
