    ...
    public partial class index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if ((Request.QueryString["SiteID"] != null) && (Request.QueryString["ReturnUrl"] != null) && (Request.QueryString["Url"] != null))
                {
                    if ((Request["SiteID"].ToString() != null) && (Request["ReturnUrl"].ToString() != null) && (Request["Url"].ToString() != null))
                    {
                ...
                if ((Session["siteid"] != null) && (Session["returnurl"] != null) && (Session["weburl"] != null))
                {
                    if ((Session["siteid"].ToString() != null) && (Session["returnurl"].ToString() != null) && (Session["weburl"].ToString() != null))
                    {
                        if (Request["Code"] != null)
                        {
                            ...
                            if (Comm.LoginOrReg(Session["siteid"].ToString(), JsonUserEmail.ToString(), OAuthSnAndId))
                            {
                                ...
                                removeSession();
                                Response.Redirect(RedirectTemp);
                                return;
                            }
                            else
                            {
        ...
        private void redirectToHinet()
        {
            ...
            "70086f70bae1964dc90336c5e71dc555e333c0dbf761ae54ffb5774bdfd6a288",
            "http://sson.ezsale.tw/Login.aspx",
            ""
            );
        ...
        private void RegMember(string OAuthSnAndId)
        {
            ...
            else
            {
                ...
                {
                    //搞那麼多驗證還有問題就掰掰踢出去!
                    RedirectTemp = Session["returnurl"].ToString();
                }
            }
            removeSession();
            Response.Redirect(RedirectTemp);
