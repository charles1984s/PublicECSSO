...
namespace ECSSO.api
{
    ...
    /// getVoices 的摘要描述
    /// </summary>
    public class getVoices : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int statement = 0;
            string returnMsg = "Something has wrong!!", tableName = "Voice";
            try
            {
        ...
        private void InsertLog(String Setting, String JobName, String JobTitle, String Detail)
        {
            using (SqlConnection conn = new SqlConnection(Setting))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@prog_name", "取得語音"));
                ...
                cmd.Parameters.Add(new SqlParameter("@filename", " getVoices.ashx"));
