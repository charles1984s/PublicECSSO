...
namespace ECSSO.api
{
    ...
    public class getHotel : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int statement = 0;
            string returnMsg = "Something has wrong!!", tableName = "Hotel";
            try
            {
                    ...
                    case 0:
                        {
                            ...
                            Hotel items = JsonConvert.DeserializeObject<Hotel>(context.Request.Params["Items"]);
                            ...
                            if (GS.MD5Check(Type + Items, ChkM))
                            {
                                ...
                                returnMsg = new CommandSetting().getDataResult(GS.GetIPAddress(), Token, strSqlConnection, Type, Lng, tableName, itemString, "", minValue, maxValue);
                            }
                            else
                            {
        ...
        private String ErrorMsg(String RspnCode, String RspnMsg, String Setting)
        {
            if (Setting != "")
            {
                InsertLog(Setting, "getHotel error", "", RspnMsg);
            }
        ...
        private void InsertLog(String Setting, String JobName, String JobTitle, String Detail)
        {
            using (SqlConnection conn = new SqlConnection(Setting))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@prog_name", "取得旅館"));
                ...
                cmd.Parameters.Add(new SqlParameter("@filename", " getHotel.ashx"));
