...
namespace ECSSO.api
{
    ...
    public class User : IHttpHandler
    {
                    ...
                    case 0:
                        {
                            ...
                            CheckUser items = JsonConvert.DeserializeObject<CheckUser>(context.Request.Params["Items"]);
                                    ...
                                    case 0:
                                        ...
                                        if (Type == "Login")
                                        {
                                            using (SqlConnection conn = new SqlConnection(cmdSetting._strSqlConnection))
                                            {
                                                ...
                                                {
                                                    cmd.Parameters.Add(new SqlParameter("@pwd", items.Pwd));
                                                ...
                                                try
                                                {
                                                    using (SqlConnection conn = new SqlConnection(cmdSetting._strSqlConnection))
                                                    {
                                                        ...
                                                        using (SqlCommand cmd = new SqlCommand("sp_NewMember2", conn))
                                                        {
                                                            ...
                                                            cmd.Parameters.Add(new SqlParameter("@id", items.ID));
                                                            cmd.Parameters.Add(new SqlParameter("@pwd", items.Pwd));
                                                            cmd.Parameters.Add(new SqlParameter("@ch_name", items.ID));
        ...
        private String ErrorMsg(String RspnCode, String RspnMsg, String Setting)
        {
            if (Setting != "")
            {
                InsertLog(Setting, "User error", "", RspnMsg);
            }
        ...
        private void InsertLog(String Setting, String JobName, String JobTitle, String Detail)
        {
            using (SqlConnection conn = new SqlConnection(Setting))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@filename", " User.ashx"));
