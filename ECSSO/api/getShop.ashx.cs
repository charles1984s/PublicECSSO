...
namespace ECSSO.api
{
    ...
    public class getShop : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int statement = 0;
            string returnMsg = "Something has wrong!!", tableName = "Shop";
            try
            {
                    ...
                    case 0:
                        {
                            ...
                            Shop items = JsonConvert.DeserializeObject<Shop>(context.Request.Params["Items"]);
        ...
        private String ErrorMsg(String RspnCode, String RspnMsg, String Setting)
        {
            if (Setting != "")
            {
                InsertLog(Setting, "getShop error", "", RspnMsg);
            }
        ...
        private void InsertLog(String Setting, String JobName, String JobTitle, String Detail)
        {
            using (SqlConnection conn = new SqlConnection(Setting))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@prog_name", "取得商店"));
                ...
                cmd.Parameters.Add(new SqlParameter("@filename", " getShop.ashx"));
