...
namespace ECSSO.api
{
    ...
    /// getNode 的摘要描述
    /// </summary>
    public class getNode : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int statement = 0;
            string returnMsg = "Something has wrong!!", tableName = "attractions";
            try
            {
                    ...
                    case 0:
                        {
                            ...
                            Node items = JsonConvert.DeserializeObject<Node>(context.Request.Params["Items"]);
                            ...
                            {
                                string itemString = "";
                                if (Type == "TotalCounts") itemString = Items;
                                else itemString = items.id;
        ...
        private String ErrorMsg(String RspnCode, String RspnMsg, String Setting)
        {
            if (Setting != "")
            {
                InsertLog(Setting, "getNode error", "", RspnMsg);
            }
        ...
        private void InsertLog(String Setting, String JobName, String JobTitle, String Detail)
        {
            using (SqlConnection conn = new SqlConnection(Setting))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@prog_name", "取得景點"));
                ...
                cmd.Parameters.Add(new SqlParameter("@filename", " getNode.ashx"));
