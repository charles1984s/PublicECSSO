...
namespace ECSSO.api
{
    ...
    public class getNews : IHttpHandler
    {
                    ...
                    case 0:
                        {
                            ...
                            News items = JsonConvert.DeserializeObject<News>(context.Request.Params["Items"]);
                            ...
                            {
                                if (Type == "TotalCounts") tableName = "News";
        ...
        private String ErrorMsg(String RspnCode, String RspnMsg, String Setting)
        {
            if (Setting != "")
            {
                InsertLog(Setting, "getNews error", "", RspnMsg);
            }
        ...
        private void InsertLog(String Setting, String JobName, String JobTitle, String Detail)
        {
            using (SqlConnection conn = new SqlConnection(Setting))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@prog_name", "取得消息"));
                ...
                cmd.Parameters.Add(new SqlParameter("@filename", " getNews.ashx"));
