...
namespace ECSSO
{
    public partial class MealLogin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Server.Transfer("GAPI/indexmeal.aspx");
                return;
            }
        ...
        protected void LinkButton5_Click(object sender, EventArgs e)
        {
            ...
            //Response.Redirect("http://sson.ezsale.tw/Login.aspx?SiteID=" + this.siteid.Value + "&ReturnUrl=" + HttpContext.Current.Server.UrlEncode(this.returnurl.Value) + "&Url=" + HttpContext.Current.Server.UrlEncode(this.weburl.Value));
            Response.Redirect("GAPI/indexmeal.aspx?SiteID=" + this.siteid.Value + "&language=" + this.language.Value + "&VerCode=" + this.VerCode.Value + "&ReturnUrl=" + HttpContext.Current.Server.UrlEncode(this.returnurl.Value) + "&Url=" + HttpContext.Current.Server.UrlEncode(this.weburl.Value));
        }
        #endregion
